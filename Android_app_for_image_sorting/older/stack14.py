...
class MainTApp(App):
    ...
    def build(self):
        ...
        cat=Button(text="Prev",size_hint=( widthOfMainButtons ,.2), background_color=(0,0,0,0.2))
        cat.bind(on_press=self.previous)
        tmp.add_widget(cat);
        
        cat=Button(text="Next",size_hint=( widthOfMainButtons ,.2), background_color=(0,0,0,0.2))
        cat.bind(on_press=self.next)
        tmp.add_widget(cat);
        
        self.act_cat =Button(text="action",size_hint=( widthOfMainButtons ,.2), background_color=(0,0,0,0.2))
        #self.act_cat=Button(text="action")
